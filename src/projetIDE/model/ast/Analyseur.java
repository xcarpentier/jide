...
public class Analyseur implements AnalyseurConstants {
    ...
    public static void main (String [] args) {
		...
		parser = new Analyseur(System.in);
	    } else if (args.length == 1)
		{
		    ...
		    try
			{
			    ...
			    parser = new Analyseur(new java.io.FileInputStream(filename));
			...
			//System.out.println("         java Analyseur < inputfile");
		...
		System.out.println("   Le Programme a analyse " + filename + " avec succes en " + (initTime + parseTime) + " ms.");
		System.out.println("      L'initialisation du programme etait de " + initTime + " ms.");
		System.out.println("      L'analyse a duree " + parseTime + " ms.");
	    } catch (ParseException e)
		{
		    System.out.println(e.getMessage());
		    System.out.println("Analyseur Java Version 1.1 (for Java 1.4 code):  Il y a des erreurs.");
		}
    }
...
// added by Andrea Gini
  ...
  static public AnalyseurTokenManager token_source;
